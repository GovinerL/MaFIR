...
root_path = '/fine-tuning/test_result/'
...
if __name__ == "__main__":
  ...
  gt_list = glob.glob('/dataset3/gt/*.jpg')
  gt_list.sort()
#  print(gt_list)
  dir_list = sorted(os.listdir('/fine-tuning/test_result/'))
#  print(len(dir_list))
#  print(dir_list)
#  record = []
  for i in range(len(dir_list)):
      if(dir_list[i]=='epoch_198' or dir_list[i]=='epoch_200' or dir_list[i]=='epoch_400'):
